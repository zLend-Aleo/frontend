export const NFTProgramId = 'your_mom.aleo';

export const NFTProgram = `program your_mom.aleo;
...
function initialize_collection:
    ...
    assert.eq self.caller aleo1p073jg034zr9p4687h59dnndr6as9d24k4jzmrf26dzm264guu9svvwh9h;
    async initialize_collection r0 r1 r2 into r3;
    output r3 as your_mom.aleo/initialize_collection.future;
...
function add_nft:
    ...
    output r4 as your_mom.aleo/add_nft.future;
...
function add_minter:
    ...
    output r3 as your_mom.aleo/add_minter.future;
...
function update_toggle_settings:
    ...
    output r1 as your_mom.aleo/update_toggle_settings.future;
...
function set_mint_block:
    ...
    output r1 as your_mom.aleo/set_mint_block.future;
...
function update_symbol:
    ...
    output r1 as your_mom.aleo/update_symbol.future;
...
function update_base_uri:
    ...
    output r1 as your_mom.aleo/update_base_uri.future;
...
function open_mint:
    ...
    output r4 as your_mom.aleo/open_mint.future;
...
function mint:
    ...
    output r7 as your_mom.aleo/mint.future;
...
function claim_nft:
    ...
    output r6 as your_mom.aleo/claim_nft.future;
...
function authorize:
    ...
    output r2 as your_mom.aleo/authorize.future;
...
function transfer_public:
    ...
    output r5 as your_mom.aleo/transfer_public.future;
...
function convert_private_to_public:
    ...
    output r3 as your_mom.aleo/convert_private_to_public.future;
...
function convert_public_to_private:
    ...
    output r5 as NFT.record;
    output r6 as your_mom.aleo/convert_public_to_private.future;
