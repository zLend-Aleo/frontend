export const NFTProgramId = 'undefined';

export const NFTProgram = `program undefined;
...
function initialize_collection:
    ...
    assert.eq self.caller undefined;
    async initialize_collection r0 r1 r2 into r3;
    output r3 as undefined/initialize_collection.future;
...
function add_nft:
    ...
    output r4 as undefined/add_nft.future;
...
function add_minter:
    ...
    output r3 as undefined/add_minter.future;
...
function update_toggle_settings:
    ...
    output r1 as undefined/update_toggle_settings.future;
...
function set_mint_block:
    ...
    output r1 as undefined/set_mint_block.future;
...
function update_symbol:
    ...
    output r1 as undefined/update_symbol.future;
...
function update_base_uri:
    ...
    output r1 as undefined/update_base_uri.future;
...
function open_mint:
    ...
    output r4 as undefined/open_mint.future;
...
function mint:
    ...
    output r7 as undefined/mint.future;
...
function claim_nft:
    ...
    output r6 as undefined/claim_nft.future;
...
function authorize:
    ...
    output r2 as undefined/authorize.future;
...
function transfer_public:
    ...
    output r5 as undefined/transfer_public.future;
...
function convert_private_to_public:
    ...
    output r3 as undefined/convert_private_to_public.future;
...
function convert_public_to_private:
    ...
    output r5 as NFT.record;
    output r6 as undefined/convert_public_to_private.future;
